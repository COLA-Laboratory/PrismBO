...
class HPOBHandler:
    ...
    def __init__(self, root_dir = "hpob-data/", mode = "v3-test", surrogates_dir="saved-surrogates/", ini_X=None, ini_Y=None):
    ...
    def evaluate_continuous(self, task, bo_method = None, search_space_id = None, dataset_id = None, seed = None, n_trials = 10):
        ...
        x_observed = self.ini_X
        y_observed = self.ini_Y
