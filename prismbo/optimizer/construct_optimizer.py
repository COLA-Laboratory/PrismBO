...
from prismbo.agent.registry import (acf_registry, sampler_registry,
                                     selector_registry, space_refiner_registry,
                                     model_registry, pretrain_registry, normalizer_registry)
from prismbo.optimizer.optimizer_base.bo import BO
from prismbo.optimizer.optimizer_base.bilevel import Bilevel
...
def ConstructOptimizer(optimizer_config: dict = None, seed: int = 0) -> BO:
    ...
    Initialization = sampler_registry[optimizer_config['Initialization']['type']](init_num=optimizer_config['Initialization']['InitNum'], config=optimizer_config['Initialization']['Parameters'])
